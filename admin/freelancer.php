...
<html lang="en-us">
	<head>
		...
		<!-- title of the page-->
		<title>
		Woo - Cur - Admin - Freelancer
		</title>
		<!--End of title-->
		
		<!--Style sheets css -->
		<link rel="stylesheet" href="css/afreelancer.css">
		<!--End of css -->
	...
	<body id="body" class="body">
		...
		<div class="searching">
				...
				<form action="freelancer.php" method="post">
					<div class="s_container">
					  <center><button type="submit" name="All">All Freelancers</button></center>
					</div>
				</form>
		</div>
		</br></br></br></br></br>
			...
			<div class="container">
						...
						<p><a href="../<?=$row['cv']?>" target="_blank"><?php if($row['cv']!=""){echo 'Resume';}?></a></p>
						<a href="inc/verify.php?fid=<?=$row['id']?>"><button><?=($row['verification']?'Verified':'Verify')?></button></a>
						<a href="inc/delete.php?fid=<?=$row['id']?>"><button>Remove</button></a>	
						</div>
						<?php
								}
						}
