...
if(isset($_POST["e_userid"])){
	$_SESSION["e_userid"]=$_POST["e_userid"];
...
<html lang="en-us">
	<head>
		...
		<!--Style sheets css -->
		<link rel="stylesheet" href="css/allclient.css">
		<!--End of css -->
								...
								while($row = $result->fetch_assoc()) {
									...
									echo '
										<div class="user_container">
											...
											<div class="desc">
											<form method="post" action="allclient.php">
											<input type="hidden" name="e_userid" value="'.$e_userid.'">
