...
<html lang="en-us">
	...
	<body id="body" class="body">
		...
		<div id="index" class="index"><br>
			<div>
				<form id="profileForm" action="include/update-photo.php" method="post" novalidate enctype="multipart/form-data">
					<h3>Profile - Photo</h3>
					...
					<img src="img/download.png" width="150px" height="150px">
					<div>
					<label for="photo">Upload you Image file in .jpg or .png format</label>
						<div>
