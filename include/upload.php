...
$result = $mysqli->query("UPDATE `job` SET `file` = '$file_path', `status` = 'completed' WHERE `id` = $pid");

$result = $mysqli->query("UPDATE `application` SET `status` = 'completed' WHERE `job_id` = $pid AND `f_user` = $fid");
